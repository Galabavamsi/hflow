...
social origin, socioeconomic position, level of education, or other status. The
...
When an incident occurs, report it promptly by emailing
[conduct@hebbianrobotics.com](mailto:conduct@hebbianrobotics.com).

Community moderators take reports of violations seriously and make every
effort to respond in a timely manner. They investigate all reports of Code of
Conduct violations by reviewing messages, logs, and recordings, or by
interviewing witnesses and other participants. Community moderators keep
...
privately with the involved parties. Communicating to the whole community may
be part of a mutually agreed-upon resolution.

## Addressing and repairing harm

If an investigation by the community moderators finds that this Code of
Conduct has been violated, they may use the following enforcement ladder to
...
a violation, moderators may skip lower rungs on the ladder.

1. **Warning**

   - **Event:** A violation involving a single incident or series of incidents.
   - **Consequence:** A private, written warning from the community moderators.
   - **Repair:** Examples include a private written apology, acknowledgment of
     responsibility, and seeking clarification on expectations.

2. **Temporarily limited activities**

   - **Event:** A repeated occurrence of a violation that previously resulted
     in a warning, or the first occurrence of a more serious violation.
   ...
   - **Repair:** Examples include making an apology, using the cooldown period
     to reflect on actions and impact, and being thoughtful about reentering
     community spaces after the period ends.

3. **Temporary suspension**

   - **Event:** A pattern of repeated violations that the community moderators
     have tried to address with warnings, or a single serious violation.
   - **Consequence:** A private, written warning with conditions for returning
...
4. **Permanent ban**
   ...
   - **Consequence:** Access to all community spaces, tools, and communication
     channels is removed. In general, permanent bans should be used rarely,
     should have strong reasoning behind them, and should only be used if other
     remedies have failed to change the behavior.
   - **Repair:** There is no possible repair in cases of this severity.

This enforcement ladder is a guideline. It does not limit the ability of
community moderators to use their discretion and judgment in keeping with the
best interests of the community.

## Scope

This Code of Conduct applies within all HFlow community spaces, including the
GitHub repository, issue tracker, pull requests, and official Discord server. It
also applies when an individual officially represents the community in public
or other spaces. Examples include using an official email address, posting
...
version 3.0, permanently available at the [Contributor Covenant 3.0 page][v3].

Contributor Covenant is stewarded by the Organization for Ethical Source and
licensed under [CC BY-SA 4.0]. For answers to common questions, see the
[Contributor Covenant FAQ]. Translations are available on the
[translations page]. Additional enforcement and community guideline resources
are available on the [resources page]. The enforcement ladder was inspired by
the work of [Mozilla's Code of Conduct team].

[covenant]: https://www.contributor-covenant.org/
[v3]: https://www.contributor-covenant.org/version/3/0/
[cc by-sa 4.0]: https://creativecommons.org/licenses/by-sa/4.0/
[contributor covenant faq]: https://www.contributor-covenant.org/faq
[translations page]: https://www.contributor-covenant.org/translations
[resources page]: https://www.contributor-covenant.org/resources
